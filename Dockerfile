...
# Download litecoin, verify checksum with sha256sum by running against all values in first column of signatures file. If this command fails, the build will fail.
